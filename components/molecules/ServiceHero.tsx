...
function ServicesHero() {
  ...
  return (
    <section className="relative w-full h-[90vh] overflow-hidden bg-neutral-900">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-l from-black/30 via-black/45 to-black/65" />
      ...
      {/* Гол контент — дэлгэцийн вертикаль голд, зvvн талд эгнvvлсэн */}
      <div className="relative z-10 flex h-full items-center">
        <div className="mx-auto w-full max-w-6xl px-8 text-white">
          <div className="max-w-2xl">
            ...
            <h1 className="mt-6 max-w-4xl select-none overflow-hidden">
              <span
            ...
            <p
              className="mt-8 max-w-xl leading-relaxed text-white/70"
              style={{
                opacity: loaded ? 1 : 0,
                transform: loaded ? "translateY(0)" : "translateY(16px)",
            ...
            >
              "Бодь Пропертийз" ХХК нь Монгол Улсын барилгын салбарын хөгжилтэй хөл
              нийлvvлэн, чанартай бvтээн байгуулалтыг хэрэгжvvлэн ажиллаж байна.
              Манай баг туршлагатай инженерvvд, бvтээлч хамт олноос бvрдэж,
              инновац, ур чадварыг эрхэмлэн ажилладаг.
            </p>

            {/* Dot progress + Play — зvvн эгнvvлсэн */}
            <div
