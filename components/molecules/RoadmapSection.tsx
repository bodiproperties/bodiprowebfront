...
import { Building2, Globe, Leaf, Sparkles, CheckCircle, Clock, Rocket } from 'lucide-react';
  ...
  const roadmapData: Milestone[] = [
    {
      ...
      highlights: {
        mn: ['Төслийн баг 25+ салбарын мэргэжилтэнтэй бүрэлдсэн', 'Анхны 2 премиум орон сууцны зөвшөөрөл'],
        en: ['Assembled core team of 25+ experts', 'Permitted initial 2 luxury developments'],
      },
    },
    {
      year: '2025',
      ...
      highlights: {
        mn: ['Олон улсын ISO 9001 сертификатжуулалт', 'BIM 3D загварчлалыг иж бүрэн нэвтрүүлсэн'],
        en: ['Achieved international ISO 9001 certification', 'Full adoption of 3D BIM coordination'],
      },
    },
    {
      year: '2026',
      ...
      highlights: {
        mn: ['LEED / BREEAM ногоон барилгын стандарт хэрэгжүүлэх', 'Төслийн багийг 150+ мэргэжилтэн болгон өргөжүүлэх'],
        en: ['Implementing LEED / BREEAM sustainability standards', 'Scaling workforce to 150+ active specialists'],
      },
    },
    {
      year: '2027',
      ...
      highlights: {
        mn: ['Хот төлөвлөлтийн 120,000м² мега төсөл', 'Олон улсын архитектурын наадмын оролцоо'],
        en: ['120,000m² master-planned urban complex', 'Participation in global architecture biennales'],
      },
    },
  ];

  return (
    <section id="roadmap" className="max-w-6xl mx-auto px-6 sm:px-8 py-20 sm:py-28">
